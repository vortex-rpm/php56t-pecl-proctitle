...
%description
This extension allows changing the current process' name on Linux and
*BSD systems. This is useful when using pcntl_fork() to identify running
...
%changelog
* Thu Feb 09 2017 Ilya Otyutskiy <ilya.otyutskiy@icloud.com> - 0.1.2-1.vortex
- Initial packaging
